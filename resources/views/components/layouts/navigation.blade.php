        ...
        <div class="sidepanel-inner d-flex flex-column">
          ...
          <div class="app-branding">
            <a class="app-logo" href="#"
              dissable><img
                ...
                alt="logo"
              /><span class="logo-text">Arsip</span></a
            >
          </div>
          <!--//app-branding-->
          ...
          <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            ...
            @can('create category')  
              {{-- <li class="nav-item"> --}}
                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                {{-- <a class="nav-link {{ Request::is('IKU') ? 'active' : '' }}" href="{{ url('indicator_create') }}">
                  <span class="nav-icon">
                    <svg
                      width="1em"
                      height="1em"
            ...
            @endcan
              ...
              <li class="nav-item has-submenu">
                ...
                >
                  <ul class="submenu-list list-unstyled">
                    <li class="submenu-item">
                      <a class="submenu-link {{ Request::is('role-and-permissions/role*') ? 'active' : '' }}" href="{{ url('role_index') }}">Role</a>
                    </li>
                    <li class="submenu-item">
                      <a class="submenu-link {{ Request::is('role-and-permissions/permission*') ? 'active' : '' }}" href="{{ url('permission_index') }}">Permission</a>
                    </li>
                    <li class="submenu-item">
                      <a class="submenu-link {{ Request::is('role-and-permissions/assign*') ? 'active' : '' }}" href="{{ url('assign_create') }}"
                        >Pemberian Akses Role</a
                      >
                    </li>
                    <li class="submenu-item">
                      <a class="submenu-link {{ Request::is('role-and-permissions/user*') ? 'active' : '' }}" href="{{ url('user_create') }}">Pemberian Akses User</a>
                    </li>
                  </ul>
                </div>
              </li>
